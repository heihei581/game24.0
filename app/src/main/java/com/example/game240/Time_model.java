...
public class Time_model extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.time_model);
    ...
    private void setupButtonListeners() {
        ...
        btnTips.setOnClickListener(v -> {
            ...
            if (countDownTimer != null) {
                ...
                showDebouncedToast("倒计时已暂停", Toast.LENGTH_SHORT);
            }
            // =================================================================
        ...
        if (!isCountdownFinished) {
            countDownTimer = new CountDownTimer(remainingTime, INTERVAL) {
                ...
                public void onTick(long millisUntilFinished) {
                    remainingTime = millisUntilFinished; // 更新剩余时间
                    long seconds = millisUntilFinished / 1000; // 转换为秒
                    tvCountdown.setText("倒计时：" + seconds + "s"); // 更新UI
                }
    ...
    private void disableAllOperations() {
        ...
        findViewById(R.id.btn_submit).setAlpha(0.5f);
        findViewById(R.id.btn_Tips).setClickable(false);
        findViewById(R.id.btn_Tips).setAlpha(0.5f);
        findViewById(R.id.btn_Refresh).setClickable(false);
        findViewById(R.id.btn_Refresh).setAlpha(0.5f);
    }
    // =================================================================
